...
public:
	...
	int   GetCurSel(void);//Novodranov
	void  SetCurSel(int index);//Novodranov

	void  SetItemDataArray(const  CArray<DWORD,DWORD>& arrItemData);//Novodranov
	DWORD GetItemData(int index);//Novodranov
...
protected:
    ...
    DWORD        m_dwStyle;
	CArray<DWORD,DWORD> m_arrItemData;//Novodranov
};
