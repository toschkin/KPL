...
void CGridCellCheck::OnClick(CPoint PointCellRelative)
{
	...
	*/	
	...
	if (GetCheckPlacement().PtInRect(PointCellRelative))
	{
		...
		if(m_bChecked)
			SetText(m_strChecked);			
		else		
			SetText(m_strUnChecked);			
		...
		dispinfo.item.strText  = m_strText;
...
//		GetGrid()->AutoSizeColumn(cell.col);
	}
}

void CGridCellCheck::OnDblClick( CPoint PointCellRelative)
{
	return;
}
//////////////////////////////////////////////////////////////////////
...
void CGridCellCheck::SetStrings(CString strChecked,CString strUnChecked)
{
	m_strChecked = strChecked;
	m_strUnChecked = strUnChecked;
}
void CGridCellCheck::GetStrings(CString& strChecked,CString& strUnChecked)
{
	strChecked = m_strChecked;
	strUnChecked = m_strUnChecked;
}
//////////////////////////////////////////////////////////////////////
