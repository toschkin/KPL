...
BOOL CIec101m::SaveToFile(CString strFile)
{ 
	CString strBuf,str;
	str.Format("PORT=%d\r\n",PORT);
	strBuf+=str;
	...
	for(int i =0; i < m_IndividualStructure101Array.GetSize(); i++)
	{
		str.Format("MAKE_DEVICE=%d\r\n",i+1);
		strBuf+=str;
		str.Format("LINK_ADDRESS=%d\r\n",m_IndividualStructure101Array[i].LINK_ADDRESS);
		strBuf+=str;
		str.Format("TYPE_ID=%d\r\n",m_IndividualStructure101Array[i].TYPE_ID);
		strBuf+=str;
		str.Format("NUM_BYTE=%d\r\n",m_IndividualStructure101Array[i].NUM_BYTE);
		strBuf+=str;
		str.Format("TYPE_ID_C_IC_NA_1=%d\r\n",m_IndividualStructure101Array[i].TYPE_ID_C_IC_NA_1);
		strBuf+=str;
		str.Format("NUM_BYTE_C_IC_NA_1=%d\r\n",m_IndividualStructure101Array[i].NUM_BYTE_C_IC_NA_1);
		strBuf+=str;
		str.Format("ORIGINATOR_ADDRESS=%d\r\n",m_IndividualStructure101Array[i].ORIGINATOR_ADDRESS);
		strBuf+=str;
		str.Format("COMMON_ADDRESS_ASDU=%d\r\n",m_IndividualStructure101Array[i].COMMON_ADDRESS_ASDU);
		strBuf+=str;
		str.Format("START_IOA=%d\r\n",m_IndividualStructure101Array[i].START_IOA);
		strBuf+=str;
		str.Format("AM_IOA=%d\r\n",m_IndividualStructure101Array[i].AM_IOA);
		strBuf+=str;
		str.Format("ADDRESS_PMZ=%d\r\n",m_IndividualStructure101Array[i].ADDRESS_PMZ);
		strBuf+=str;
		str.Format("POZITION_OF_QUALITY_FLAG=%d\r\n",m_IndividualStructure101Array[i].POZITION_OF_QUALITY_FLAG);
		strBuf+=str;
		str.Format("C_CS_ENABLE=%d\r\n",m_IndividualStructure101Array[i].C_CS_ENABLE);
		strBuf+=str;
		str.Format("GLOBAL_ASDU=%d\r\n",m_IndividualStructure101Array[i].GLOBAL_ASDU);
		strBuf+=str;
		str.Format("STATUS_ADDRESS_PMZ=%d\r\n",m_IndividualStructure101Array[i].STATUS_ADDRESS_PMZ);
		strBuf+=str;
		str.Format("STATUS_MASKA=%d\r\n",m_IndividualStructure101Array[i].STATUS_MASKA);
		strBuf+=str;
		str.Format("STATUS_TYPE=%d\r\n",m_IndividualStructure101Array[i].STATUS_TYPE);
		strBuf+=str;
		str.Format("//%s\r\n\r\n",m_IndividualStructure101Array[i].strCOMMENT);
		strBuf+=str;
	}
...
BOOL CIec101m::LoadFromFile(CString strFile)
{
	CFile f;
	CString strBuf,str;
	try
	{
		...
		do
		{
			...
			if(str.Find("NUMBER_OF_INDIVIDUAL_STRUCTURES") != -1)
			{
				...
				str.Trim();str.Trim("=");
				m_IndividualStructure101Array.SetSize(atoi(str));
			}
			...
			if(str.Find("MAKE_DEVICE") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((atoi(str) > 0)&&(atoi(str) <= m_IndividualStructure101Array.GetSize()))				
			...
			if(str.Find("LINK_ADDRESS") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].LINK_ADDRESS = atoi(str);										
			}
			if((str.Find("TYPE_ID") != -1)&&(str.Find("TYPE_ID_C_IC_NA_1") == -1))
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].TYPE_ID = atoi(str);										
			}
			if((str.Find("NUM_BYTE") != -1)&&(str.Find("NUM_BYTE_C_IC_NA_1") == -1))
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].NUM_BYTE = atoi(str);										
			}
			if(str.Find("TYPE_ID_C_IC_NA_1") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].TYPE_ID_C_IC_NA_1 = atoi(str);										
			}
			if(str.Find("NUM_BYTE_C_IC_NA_1") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].NUM_BYTE_C_IC_NA_1 = atoi(str);										
			}
			if(str.Find("ORIGINATOR_ADDRESS") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].ORIGINATOR_ADDRESS = atoi(str);										
			}
			if(str.Find("COMMON_ADDRESS_ASDU") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].COMMON_ADDRESS_ASDU = atoi(str);										
			}
			if(str.Find("START_IOA") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].START_IOA = atoi(str);										
			}
			if(str.Find("AM_IOA") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].AM_IOA = atoi(str);										
			}
			if((str.Find("ADDRESS_PMZ") != -1)&&(str.Find("STATUS_ADDRESS_PMZ") == -1))
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].ADDRESS_PMZ = atoi(str);										
			}
			if(str.Find("POZITION_OF_QUALITY_FLAG") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].POZITION_OF_QUALITY_FLAG = atoi(str);										
			}
			if(str.Find("C_CS_ENABLE") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].C_CS_ENABLE = atoi(str);										
			}
			if(str.Find("GLOBAL_ASDU") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].GLOBAL_ASDU = atoi(str);										
			}
			if(str.Find("STATUS_ADDRESS_PMZ") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].STATUS_ADDRESS_PMZ = atoi(str);
			}
			if(str.Find("STATUS_MASKA") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].STATUS_MASKA = atoi(str);
			}
			if(str.Find("STATUS_TYPE") != -1)
			{
				...
				str.Trim();str.Trim("=");
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].STATUS_TYPE = atoi(str);
			}			
			if(str.Find("//") != -1)
			{
				str.TrimLeft("//");				
				...
				str.Remove('\r');
				if((nProcIndex >= 0)&&(nProcIndex < m_IndividualStructure101Array.GetSize()))
					m_IndividualStructure101Array[nProcIndex].strCOMMENT = str;														
			}
...
BOOL CIec101m::SaveToTuFile(CString strFile)
{
...
BOOL CIec101m::LoadFromTuFile(CString strFile)
{
	CFile f;
	CString strBuf,str;
	try
