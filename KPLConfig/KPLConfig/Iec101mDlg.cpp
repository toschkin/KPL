// Iec101mDlg.cpp: файл реализации
//
...
{
	nProcNum=0;
	strTitle.Format("Процесс №%d: IEC 870-5-101 (MASTER)",nProcNum);
	m_nStartPMZAddr=0;
	m_nEndPMZAddr=0;
...
// обработчики сообщений CIec101mDlg
...
BOOL CIec101mDlg::OnInitDialog()
{
	...
	m_Grid.SetItemText(19,0,"Резервный порт");
